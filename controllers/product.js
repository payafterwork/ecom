...
const _ = require('lodash'); // for ._extend used in update method
...
exports.update = (req, res) => {
    ...
    form.parse(req, (err, fields, files) => {
        ...
        let product = req.product; // rather than creating, request that product object
        product = _.extend(product, fields); //we extend the fields with updated ones. 
